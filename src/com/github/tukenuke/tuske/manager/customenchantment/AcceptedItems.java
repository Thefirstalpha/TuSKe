...
public enum AcceptedItems {    
	...
	SHOVELS (new Material[]{Material.DIAMOND_SHOVEL}),
	TOOLS (new Material[]{Material.DIAMOND_PICKAXE, Material.DIAMOND_AXE, Material.DIAMOND_SHOVEL}),
	ARMOR(new Material[]{Material.DIAMOND_BOOTS, Material.DIAMOND_LEGGINGS, Material.DIAMOND_CHESTPLATE, Material.DIAMOND_HELMET}), 
	ALL(new Material[]{Material.DIAMOND_BOOTS, Material.DIAMOND_LEGGINGS, Material.DIAMOND_CHESTPLATE, Material.DIAMOND_HELMET, Material.DIAMOND_PICKAXE, Material.DIAMOND_AXE, Material.DIAMOND_SHOVEL, Material.FISHING_ROD, Material.BOW, Material.DIAMOND_SWORD});
