		...
		if (e instanceof InventoryClickEvent){
			...
			switch (type){
				...
				case 11:
					...
					if (c != null) {
						Component component = ((InventoryClickEvent) e).getView().title();
						if(component!=null) {
							String serialized_title = LegacyComponentSerializer.legacyAmpersand().serialize(component);
							return new String[]{serialized_title};
						}
					}
					break;
				case 12:
			...
			switch (type) {
				...
				case 11:
					if (((InventoryCloseEvent) e).getInventory() != null) {
						Component component = ((InventoryCloseEvent) e).getView().title();
						String serialized_title = LegacyComponentSerializer.legacyAmpersand().serialize(component);
						return new String[]{serialized_title};
					}
					break;
